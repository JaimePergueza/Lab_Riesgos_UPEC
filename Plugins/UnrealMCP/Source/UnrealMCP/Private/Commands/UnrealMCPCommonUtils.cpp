...
{
    // 1. Si ya es una ruta completa (empieza con /Game/ o /Script/), usarla directamente
    ...
    // 2. Intentar la ruta por defecto /Game/Blueprints/
    {
    ...
    // 3. Buscar en todo el proyecto usando el AssetRegistry (busca por nombre de asset)
    {
